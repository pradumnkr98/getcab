    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book_cab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                location = getLocationFromAddress(oneway_bookingsummary.this, pickup_location);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (map.get(0) != null && map.get(1) != null) {
                        ...
                        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(oneway_bookingsummary.this);
