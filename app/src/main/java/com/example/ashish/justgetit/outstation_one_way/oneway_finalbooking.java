...
public class oneway_finalbooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  services_types.add(new car_services_types(R.drawable.imini, "Mini"));
        ...
        Schedule_ride.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(oneway_finalbooking.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        return new TimePickerDialog(oneway_finalbooking.this, time_listener, hour,
                minute, true);
    }
